...
Periodic.inventory <-function(item=1){
...
while(t<=262){
  ...
  if(item==12){
    ...
    if(t %% floor(m[item])==0){
      #b<-t+1
      #print(t+1)
     period.mat[2,t]<- stock.level[item]-(period.mat[3,t-1]-dem[item])
...
as.data.frame(Periodic.inventory(item=30))
#stock.level[5]
#product_data

#Periodic.inventory(30)
