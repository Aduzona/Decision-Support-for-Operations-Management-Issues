...
#Exercise 5: 
Change the problem by adding constraints that prohibit the center to be closer than 0.5 diatance units to any point
```{r}
...
#bounds loc[1]= [-Inf,Inf], loc[2]=[-Inf,Inf] thus the rep(Inf,2) range values for x axis of both loc[1] and loc[2], rep(-Inf,2) range valuesfor y axis of both loc[1] and loc[2]
copt <- OP(
