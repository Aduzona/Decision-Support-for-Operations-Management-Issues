...
$$ min \rightarrow (c^{-or} \cdot \sum_{i=1}^{n=62} \frac {de_i}{q_i} \cdot c_i^{or}) + (h \cdot \sum_{i=1}^{n=62} \frac {q_i}{2}\cdot pr_i ) $$
...
$$\sum_{i \in \mathcal I } q_{ik} \cdot b_{ji\space length} \le n_{k} \qquad \forall k \in \mathcal K $$
# Rack Width
...
$$\sum_{k \in \mathcal K } q_{kj} \cdot b_{ji\space width} \le rack_{total_{Width}}$$
