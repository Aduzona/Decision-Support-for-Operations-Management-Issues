...
$$ q_i^* = \sqrt \frac {2 \cdot d_i \cdot (c_i^{or}+c^{-or})} {c_i^{sh}}$$
$\frac {d_i}{q_i}=$ no of orders per day for part $i$
$\frac {q_i}{2}=$ average inventory for part $i$
$$ min \rightarrow ((c_i^{or}+c^{-or}) \cdot \sum_{i=1}^{n=62} \frac {d_i}{q_i}) + (h \cdot \sum_{i=1}^{n=62} \frac {q_i}{2}\cdot p_i ) $$
...
maximum number of box 3103147 in runway is $n_k= \frac {6000}{198}=30.30=30 boxes\\$
...
$x_{ik}=$ number of boxes ordered for part $i$ in runway $k \qquad$ $b_{ji\space length}$ is the length of box id $j$ containing part $i\\$
